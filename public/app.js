...
function renderPendleAnalytics(data) {
  ...
  }).join("")}</div><p class="pendle-note">YT total PnL uses Pendle's lifetime market net gain plus currently unclaimed yield. Current cost basis applies only to the open bag; base and reinvested history can be incomplete after external transfers.</p></section>`;
}
